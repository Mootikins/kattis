...
int main() {
	...
	for ( int i = 1; i < songLen; i++ ) {
		...
		if ( note % 12 == 0 && note % 12 == 2 && note % 12 == 5 && note % 12 == 7 &&
		     note % 12 == 10 )
			temp = 2;

		if ( note2 % 12 == 0 && note2 % 12 == 2 && note2 % 12 == 5 &&
		     note2 % 12 == 7 && note2 % 12 == 10 )
			temp++;
		...
		if ( note != note2 ) {
			...
			if ( note % 12 + 1 < 4 && note2 % 12 + 1 >= 4 ||
			     note2 % 12 + 1 < 4 && note % 12 + 1 >= 4 ) {
				if ( song[i].first < 0 )
					song[i].first--;
				else
					song[i].first++;
			...
			if ( note % 12 + 1 < 9 && note2 % 12 + 1 >= 9 ||
			     note2 % 12 + 1 < 9 && note % 12 + 1 >= 9 ) {
				if ( song[i].first < 0 )
					song[i].first--;
				else
					song[i].first++;
