...
int main ( int argc, char* argv[] )
{
	...
	for ( int i = 0; i < tris; ++i ) {
		...
		if ( angle1 < EPSILON || angle1 > 180 - EPSILON )
			...
			cout << "Case #" << i + 1 << ":" << " not a triangle" << endl;
		else if ( ( angle1-angle2 <= EPSILON ) || ( angle2-angle3 <= EPSILON ) || ( angle3-angle1 <= EPSILON ) ) {
			if ( angle1-angle2 <= EPSILON && angle3 < 90 )
				cout << "Case #" << i + 1 << ":" << " isosceles acute triangle" << endl;
			else if ( angle2-angle3 <= EPSILON && angle1 < 90 )
				cout << "Case #" << i + 1 << ":" << " isosceles acute triangle" << endl;
			else if ( angle3-angle1 <= EPSILON && angle2 < 90 )
				cout << "Case #" << i + 1 << ":" << " isosceles acute triangle" << endl;
			else if ( angle1-angle2 <= EPSILON && angle3 > 90 )
				cout << "Case #" << i + 1 << ":" << " isosceles obtuse triangle" << endl;
			else if ( angle2-angle3 <= EPSILON && angle1 > 90 )
				cout << "Case #" << i + 1 << ":" << " isosceles obtuse triangle" << endl;
			else if ( angle3-angle1 <= EPSILON && angle2 > 90 )
				cout << "Case #" << i + 1 << ":" << " isosceles obtuse triangle" << endl;
			...
			cout << "Case #" << i + 1 << ":" << " scalene acute triangle" << endl;
		else if ( angle1-90 < EPSILON && angle2-90 < EPSILON && angle3 > 90 )
			cout << "Case #" << i + 1 << ":" << " scalene obtuse triangle" << endl;
