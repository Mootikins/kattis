...
{
  bool c[] = {false, true, true, true, false,\
            false, true, true, true, true};

  bool d[] = {false, true, true, true, false,\
            false, true, true, true, false};

  bool e[] = {false, true, true, true, false,\
  ...
  bool D[] = {true, true, true, true, false,\
            false, true, true, true, false};

  bool E[] = {true, true, true, true, false,\
            false, true, true, false, false};

  bool F[] = {true, true, true, true, false,\
            false, true, false, false, false};

  bool G[] = {true, true, true, true, false,\
            false, false, false, false, false};
